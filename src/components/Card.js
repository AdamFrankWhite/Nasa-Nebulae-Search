    ...
    return (
        <div className={props.multi === 1 ? "single-card" : "card"} style={cardStyle}>
            ...
            <ul className="social-media">
                <a href={`http://www.facebook.com/sharer.php?u=${props.imgData[1]}`} target="_blank"><li><i className="fa fa-facebook" aria-hidden="true"></i></li></a>
                <a href={`https://twitter.com/share?url=${props.imgData[1]}&amp;text=${props.caption};hashtags=NASA`} target="_blank"><li><i className="fa fa-twitter" aria-hidden="true"></i></li></a>
                ...
                <a href={`http://reddit.com/submit?url=${props.imgData[0]}`} target="_blank"><li><i className="fa fa-reddit" aria-hidden="true"></i></li></a>
            </ul>
        </div>
    )
